...
?>
    ...
    <a href="edit_cerpen.php?id=<?php echo $data[0]['id_karya']; ?>" class="btn btn-success">Edit</a> |
    <a href="hapus_cerpen.php?id=<?php echo $data[0]['id_karya']; ?>" class="btn btn-danger">Hapus</a> |
