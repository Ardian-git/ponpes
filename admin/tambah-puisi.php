    ...
    <div class="container">
        <div class="card">
            <div class="card-body" style="background:#EDEDED;">
                <h2 style="text-align:center;">Form Input Puisi</h2>
                <form action="simpan-puisi.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kat" class="form-control" value="puisi" readonly>
                    </div>
